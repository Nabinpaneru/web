            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <form action="{{ route('save.protfolio') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" name="protfolio_name">
                             ...
                             <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" name="protfolio_tittle">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" id="exampleInputEmail1" name="protfolio_description" value=""
                                    rows="5"></textarea>
                            ...
                            <button type="submit" class="btn btn-info">Save Protfolio</button>
